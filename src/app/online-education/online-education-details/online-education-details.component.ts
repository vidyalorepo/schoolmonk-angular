...
@Component({
  selector: 'app-online-education-details',
  templateUrl: './online-education-details.component.html',
  styleUrls: ['./online-education-details.component.css'],
  providers:[ConfirmationService,MessageService]
})
export class OnlineEducationDetailsComponent implements OnInit {
  blogSlug: string;
  blogdata: any;
