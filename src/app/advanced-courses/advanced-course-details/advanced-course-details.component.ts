...
@Component({
  selector: 'app-advanced-course-details',
  templateUrl: './advanced-course-details.component.html',
  styleUrls: ['./advanced-course-details.component.css'],
  providers:[ConfirmationService,MessageService]
})
export class AdvancedCourseDetailsComponent implements OnInit {
  blogSlug: string;
  blogdata: any;
